...
const categories = [
  { name: 'Housing', slug: 'housing', color: '#ef4444', type: Type.EXPENSE },
  {
  ...
  { name: 'Food', slug: 'food', color: '#84cc16', type: Type.EXPENSE },
  { name: 'Health', slug: 'health', color: '#10b981', type: Type.EXPENSE },
  {
    name: 'Education',
    slug: 'education',
    color: '#06b6d4',
  ...
  { name: 'Others', slug: 'others', color: '#9ca3af', type: Type.EXPENSE },

  { name: 'Salary', slug: 'salary', color: '#22c55e', type: Type.REVENUE },
  {
  ...
  { name: 'Rentals', slug: 'rentals', color: '#14b8a6', type: Type.REVENUE },
  { name: 'Refunds', slug: 'refunds', color: '#3b82f6', type: Type.REVENUE },
  {
  ...
  { name: 'Others', slug: 'others', color: '#9ca3af', type: Type.REVENUE },
]
