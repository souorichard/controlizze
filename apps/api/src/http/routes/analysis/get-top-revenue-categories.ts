  ...
  app
    ...
    .get(
      ...
      async (request) => {
        ...
        const topRevenuesCategories = await prisma.transaction.groupBy({
          by: ['category'],
          _sum: {
            amount: true,
          },
        ...
        const formattedTopRevenuesCategories = topRevenuesCategories.map(
          (category) => ({
        ...
        return {
          categories: formattedTopRevenuesCategories,
        }
      },
    )
}
